...
<head>
    ...
    <style>
        ...
        .login_boder{ background-color :white;no-repeat;overflow:hidden;height:480px;border-radius:5px;}
...
<div class="login_m">
    <div class="login_boder">
        ...
        <form class="form-horizontal" action="{{ url('auth/adminregister') }}" method="POST">
            {{csrf_field()}}
